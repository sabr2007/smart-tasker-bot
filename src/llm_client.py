...
8. Когда ты возвращаешь пользователю активные задачи - делай это в формате списка, где каждая задача на отдельной строке с нумерацией и дедлайн для каждой задачи указан через тире. 
