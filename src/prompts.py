...
2. ПЕРЕНОС задачи:
   ...
   - "поставь/добавь дедлайн/срок к задаче ..." → это add_deadline (добавить дедлайн существующей задаче).
   - "перенеси/измени дедлайн/сдвинь срок ..." → это reschedule (изменить уже существующий дедлайн).
